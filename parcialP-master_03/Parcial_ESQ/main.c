            ...
            case 4:
                do
                {
                    ...
                    switch(opcion4)
                    {
                        ...
                        cantidad_tipos_orquesta(arrayOrquestas,CANTIDAD_ORQUESTAS);
                        break;
                        case 2:
                            cantidad_tipos_instrumento(arrayInstrumentos,CANTIDAD_INSTRUMENTOS);
                            break;
                        case 3:
                            cantidadOrquestas(arrayOrquestas,CANTIDAD_ORQUESTAS);
                            break;
                        case 4:
                            cantidadInstrumentos(arrayInstrumentos,CANTIDAD_INSTRUMENTOS);
                            break;
                        case 5:
                            cantidadMusicos(arrayMusicos,CANTIDAD_MUSICOS);
                            break;
                        case 6:
                            cantidad_tipos_orquesta_y_nombres(arrayOrquestas,CANTIDAD_ORQUESTAS);
                            break;
                        case 7:
                            cantidad_tipos_instrumento_y_nombres(arrayInstrumentos,CANTIDAD_INSTRUMENTOS);
                            break;
                        case 8:
                            promedio_edad_musicos(arrayMusicos,CANTIDAD_MUSICOS);
                            break;
                        case 9:
                            promedio_cantidad_musicos_por_orquesta(arrayMusicos,arrayOrquestas,CANTIDAD_MUSICOS,CANTIDAD_ORQUESTAS);
                            break;
                        case 10:
                            musicos_segun_instrumento(arrayMusicos,arrayInstrumentos,CANTIDAD_MUSICOS,CANTIDAD_INSTRUMENTOS);
                            break;
                        case 11:
                            musicos_segun_orquesta(arrayMusicos,arrayOrquestas,CANTIDAD_MUSICOS,CANTIDAD_ORQUESTAS);
                            break;
                        case 12:
                            musicos_ordenarDobleCriterio(arrayMusicos,CANTIDAD_MUSICOS,SORT_DOWN,SORT_UP);
                            musicos_print(arrayMusicos,CANTIDAD_MUSICOS);
                            break;
                        default:
